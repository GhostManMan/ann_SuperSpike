...
nbrOfPatches = 400000
duration = 125
inputsize = 28#36 # size of the entire input pach which is shown
size_Exc = 18 # size of height and weight for the two dimensional input//size of the segmentation window
rf_Shift = 10 #(inputsize/size_Exc)-1
#---------------------------------neuron definitions-------------------------
...
projLGN_V1 = Projection(
    ...
    rfY=size_Exc, 
    offsetX=0, 
    offsetY=0)#connect_all_to_all(weights = Uniform(0.025,1.0)) #
...
projLGN_Inhib = Projection(
    ...
    rfY=size_Exc, 
    offsetX=0, 
    offsetY=0)#.connect_all_to_all(weights = Uniform(0.01,0.15))#
...
def setInputPatch(Input):
    ...
    #inputPatch = np.random.normal(0,0.5,(inputsize,inputsize,2))
    #maxVal = 1.0
    popInput.rates = inputPatch/maxVal *100.0
    #popInput.rates = np.random.poisson(50)#inputPatchOn*100
    #print(popInput.rates)
...
def run():
    createDir()
    compile()
    #print(np.shape(projLGN_V1.w))
    print(np.shape(projV1_Inhib.w))
    #print(np.shape(projInhib_V1.w))
    d = projInhib_V1.dendrite(0)
    #print(len(d.pre_rank))
    #print(d.pre_rank)
    #------- neuron Monitors --------#
    ...
    #------------print Spikes---------------#
#    print('Number of Spikes from Input - Population[firstElemnt]:')
#    print(inptSpk)#*1000/(duration*nbrOfPatches))
#    print('------------------------------------------')
#    print('Number of Spikes of LGN - Population[firstElement]: ')
#    print(LGNSpk)#*1000/(duration*nbrOfPatches))
#    print('------------------------------------------')
#    print('Number of Spikes of V1 - Population[firstElement]: ')
#    print(v1Spk)#*1000/(duration*nbrOfPatches))
#    print('------------------------------------------')

#    print(input_Exc[0][0].w)
#    print(output_spikes)
  ...
  #----------------plot output---------------#
    ...
    mp.pyplot.close('all')
#    plt.plotgEx_gInh(l2gExc,l2gInh,'Exi')
    plt.plotVM(l2VM,'Exi')
 ...
 #   mp.pyplot.figure()
 #   mp.pyplot.plot(ffW[:,0])
 #   mp.pyplot.savefig('output/ffW.png')
